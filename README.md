# أصيل عبدالجليل أحمد الصبري | Aseel Al-Sabri
...
### 🚀 المسار التقني الحالي | Current Tech Path
أركز بشكل أساسي على تطوير تطبيقات الويب الحديثة باستخدام تقنيات **Next.js** و **React**. أمتلك شغفاً كبيراً بتصميم واجهات المستخدم (Frontend) وضمان تجربة مستخدم (UX) سلسة باستخدام **TypeScript** و **Tailwind CSS**.

### ⚙️ الجانب الهندسي وقواعد البيانات
في الجانب الخلفي (Backend)، أعمل على بناء أنظمة برمجية متينة وإدارة قواعد البيانات باستخدام **MySQL** لضمان تقديم حلول تقنية مستقرة وقابلة للتوسع.
